      ...
      <div className="container mx-auto px-10 py-8">
        ...
        <div className="grid md:grid-cols-3 gap-2 items-center">
          ...
          <div className="flex justify-end pr-8">
           <div className="text-center">
            ...
            <div className="bg-white px-6 py-3 rounded-lg shadow-sm">
              ...
              <div className="text-2xl font-bold text-purple-600">10 Jahre</div>
            </div>
          </div>
          </div>
          ...
          <div className="flex flex-col items-center">
            ...
            <div className="flex gap-6">
              ...
              <a
                href="mailto:minuciaundco@gmail.com"
                className="p-3 rounded-full bg-gray-100 hover:bg-gray-200 transition-colors"
              >
        ...
        <div className="text-center mt-12">
          ...
          >
            ...
            {"auf denen ich mit Farben, Formen und Ideen jongliere.".split('').map((char, index) => (
              <motion.span
                key={index}
                style={{
                  display: 'inline-block',
                  x: useTransform(scrollY, [600, 800], [0, Math.random() * 1000 - 500]),
                  y: useTransform(scrollY, [600, 800], [0, Math.random() * 1000 - 500]),
                  rotate: useTransform(scrollY, [600, 800], [0, Math.random() * 360]),
                  opacity: useTransform(scrollY, [600, 700, 800], [1, 0.5, 0])
                }}
              >
                {char === " " ? "\u00A0" : char}
              </motion.span>
