  ...
  const milestones = [
    {
      ...
      description: 'Praxisnahe KI-Kenntnisse für effiziente und kreative Anwendungen im Arbeitsalltag.'
    },
    {
      icon: Briefcase,
      ...
      description: 'Leitung im Bereich Media Design: Verantwortung für Print- und Digitalprojekte, inklusive Teamführung und crossmedialer Expertise.'
    },
    {
      icon: Award,
      ...
      description: 'Intensives Training mit Fokus auf nutzerzentriertem Design, Prototyping und kreativer Gestaltung für intuitive digitale Erlebnisse.'
    },
    {
      icon: Award,
      ...
      period: '2021',
      description: 'Qualifikation zur professionellen Planung, Durchführung und Betreuung von Ausbildungsprozessen gemäß der Ausbilder-Eignungsverordnung.'
    },
    {
      icon: Briefcase,
      ...
      period: '2017 - 2019',
      description: 'Komplette Projektbetreuung: Von Kundengesprächen über Designentwicklung bis zur Terminplanung für Montage.'
    },
    {
      icon: GraduationCap,
